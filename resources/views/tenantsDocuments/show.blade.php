                                                ...
                                                <div class="col-md-6">
                                                    <div class="card card-widget widget-user shadow">
                                                        <div class="widget-user-header bg-info">
                                                            <h3 class="widget-user-username">{{ $administrative->name }}
                                                            </h3>
                                                            <h5 class="widget-user-desc">
                                                                {{ __('Administrative responsible') }}</h5>
                                                        </div>
                                                        @php
                                                        ...
                                                        <div class="small-box bg-info">
                                                            <a href="{{ route('users.show', $administrative->id) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
