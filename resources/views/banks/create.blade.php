                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_code" name="bank_code" value="{{ old('bank_code', null) }}" maxlength="3"
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', null) }}" maxlength="100" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                    required>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="short_name" name="short_name" value="{{ old('short_name', null) }}" maxlength="50"
