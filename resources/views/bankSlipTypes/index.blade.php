                ...
                <tbody>
                    @foreach ($bankSlipTypes as $bankSlipType)
                        <tr>
                            ...
                            <td class="text-right">
                                @if ($bankSlipType->suspended == null)
                                    <form action="{{ route('bankSlipTypes.suspend', [$bankSlipType->id]) }}"
                                ...
                                @endif
                                <a href="{{ route('bankSlipTypes.edit', [$bankSlipType->id]) }}" class="btn btn-sm btn-info "><i
                                        class="fas fa-pencil-alt"></i> {{ __('Edit') }}</a>
                                <form action="{{ route('bankSlipTypes.destroy', [$bankSlipType->id]) }}"
