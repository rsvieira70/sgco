                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $professional->name, null) }}" maxlength="50"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="social_name" name="social_name" value="{{ old('social_name', $professional->social_name, null) }}" maxlength="50"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="nickname" name="nickname" value="{{ old('nickname', $professional->nickname, null) }}" maxlength="30"
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="social_security_number" name="social_security_number" value="{{ old('social_security_number', $professional->social_security_number, null) }}"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="date" id="birth" name="birth" value="{{ old('birth', $professional->birth, null) }}" class="form-control @error('birth') is-invalid @enderror" required>
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                ...
                                <div class="Input-group">
                                    ...
                                    <input type="file" id="image" name="image" value="{{ old('image', $professional->image, null) }}" class="form-control @error('image') is-invalid @enderror">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="zip_code" name="zip_code" value="{{ old('zip_code', $professional->zip_code, null) }}" maxlength="8"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="address" name="address" value="{{ old('address', $professional->address, null) }}" maxlength="70"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="house_number" name="house_number" value="{{ old('house_number', $professional->house_number, null) }}" maxlength="10"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="complement" name="complement" value="{{ old('complement', $professional->complement, null) }}" maxlength="30"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="neighborhood" name="neighborhood" value="{{ old('neighborhood', $professional->neighborhood, null) }}" maxlength="30"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city', $professional->city, null) }}" maxlength="50"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="state" name="state" value="{{ old('state', $professional->state, null) }}" maxlength="2"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="dceu" name="dceu" value="{{ old('dceu', $professional->dceu, null) }}" maxlength="7"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="telephone" name="telephone" value="{{ old('telephone', $professional->telephone, null) }}" maxlength="10"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="cell_phone" name="cell_phone" value="{{ old('cell_phone', $professional->cell_phone, null) }}" maxlength="11"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="whatsapp" name="whatsapp" value="{{ old('whatsapp', $professional->whatsapp, null) }}" maxlength="11"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="telegram" name="telegram" value="{{ old('telegram', $professional->telegram, null) }}" maxlength="11"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="facebook" name="facebook" value="{{ old('facebook', $professional->facebook, null) }}" maxlength="80"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="instagram" name="instagram" value="{{ old('instagram', $professional->instagram, null) }}" maxlength="80"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="twitter" name="twitter" value="{{ old('twitter', $professional->twitter, null) }}" maxlength="80"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="linkedin" name="linkedin" value="{{ old('linkedin', $professional->linkedin, null) }}" maxlength="80"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $professional->email, null) }}" maxlength="255"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="profile_note" class="form-control @error('profile_note') is-invalid @enderror" rows="4" style="height: 30mm">{{ old('profile_note', $professional->profile_note, null) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
