...
@endsection;
@section('content')
    <form action="{{ route('professionals.update', $professional->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-12">
                <div class="invoice p-3 mb-3">
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            <div class="input-field">
                                <select class="custom-select" id="patent_id" name="patent_id" class="form-control @error('patent_id') is-invalid @enderror" required>
                                    @foreach ($patents as $patent)
                                        <option value="{{ $patent->id }}" {{ old('patent_id', $professional->patent_id) == $patent->id ? 'selected' : '' }}>
                                            {{ $patent->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $professional->name) }}" maxlength="50"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="social_name" name="social_name" value="{{ old('social_name', $professional->social_name) }}" maxlength="50"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="nickname" name="nickname" value="{{ old('nickname', $professional->nickname) }}" maxlength="30"
                    ...
                    <div class="row">
                            ...
                            <div class="input-field">
                                <select class="custom-select" id="specialty_id" name="specialty_id" class="form-control @error('specialty_id') is-invalid @enderror" required>
                                    @foreach ($specialties as $specialty)
                                        <option value="{{ $specialty->id }}" {{ old('specialty_id', $professional->specialty_id) == $specialty->id ? 'selected' : '' }}>
                            ...
                            <div class="input-field">
                                <select class="custom-select" id="council_id" name="council_id" class="form-control @error('council_id') is-invalid @enderror" required>
                                    @foreach ($councils as $council)
                                        <option value="{{ $council->id }}" {{ old('council_id', $professional->council_id) == $council->id ? 'selected' : '' }}>
                                            {{ $council->short_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="council_number" name="council_number" value="{{ old('council_number', $professional->council_number) }}" maxlength="10"
                            ...
                            <div class="input-field">
                                <select class="custom-select" id="council_state_id" name="council_state_id" class="form-control @error('council_state_id') is-invalid @enderror" required>
                                    @foreach ($states as $state)
                                        <option value="{{ $patent->id }}" {{ old('council_state_id', $professional->council_state_id) == $state->id ? 'selected' : '' }}>
                                            {{ $state->description }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="date" id="registration_date" name="registration_date" value="{{ old('registration_date', $professional->registration_date) }}"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="social_security_number" name="social_security_number"
                                        value="{{ old('social_security_number', $professional->social_security_number) }}" maxlength="11"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="date" id="birth" name="birth" value="{{ old('birth', $professional->birth) }}" class="form-control @error('birth') is-invalid @enderror"
                                    required>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="zip_code" name="zip_code" value="{{ old('zip_code', $professional->zip_code) }}" maxlength="8"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="address" name="address" value="{{ old('address', $professional->address) }}" maxlength="70"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="house_number" name="house_number" value="{{ old('house_number', $professional->house_number) }}" maxlength="10"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="complement" name="complement" value="{{ old('complement', $professional->complement) }}" maxlength="30"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="neighborhood" name="neighborhood" value="{{ old('neighborhood', $professional->neighborhood) }}" maxlength="30"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city', $professional->city) }}" maxlength="50"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="state" name="state" value="{{ old('state', $professional->state) }}" maxlength="2"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="dceu" name="dceu" value="{{ old('dceu', $professional->dceu) }}" maxlength="7"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="telephone" name="telephone" value="{{ old('telephone', $professional->telephone) }}" maxlength="10"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="cell_phone" name="cell_phone" value="{{ old('cell_phone', $professional->cell_phone) }}" maxlength="11"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="whatsapp" name="whatsapp" value="{{ old('whatsapp', $professional->whatsapp) }}" maxlength="11"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="telegram" name="telegram" value="{{ old('telegram', $professional->telegram) }}" maxlength="11"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="facebook" name="facebook" value="{{ old('facebook', $professional->facebook) }}" maxlength="80"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="instagram" name="instagram" value="{{ old('instagram', $professional->instagram) }}" maxlength="80"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="twitter" name="twitter" value="{{ old('twitter', $professional->twitter) }}" maxlength="80"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="linkedin" name="linkedin" value="{{ old('linkedin', $professional->linkedin) }}" maxlength="80"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="website">{{ __('Email') }}</label>
                                <input type="website" id="website" name="website" value="{{ old('website', $professional->website) }}" maxlength="255"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $professional->email) }}" maxlength="255"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="note" class="form-control @error('note') is-invalid @enderror" rows="4" style="height: 30mm">{{ old('note', $professional->note) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group clearfix">
                                <div class="icheck-primary d-inline">
                                    <input type="checkbox" id="make_clinical_budget" name="make_clinical_budget" value="1"
                                        {{ old('make_clinical_budget', $professional->make_clinical_budget) ? 'checked' : '' }}>
                            ...
                            <div class="form-group clearfix">
                                <div class="icheck-primary d-inline">
                                    <input type="checkbox" class="form-control @error('responsible_dentist') is-invalid @enderror" id="responsible_dentist" name="responsible_dentist" value="1"
                                        {{ old('responsible_dentist', $professional->responsible_dentist) ? 'checked' : '' }}>
