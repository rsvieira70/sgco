                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="custom-select" id="department_id" name="department_id" class="form-control @error('department_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}" {{ old('department_id', $department->department->id ?? '') == $department->id ? 'selected' : '' }}>
                                    ...
                                    <div class="input-field">
                                        <select class="custom-select" id="position_id" name="position_id" class="form-control @error('position_id') is-invalid @enderror" required>
                                            ...
                                            @foreach ($positions as $position)
                                                <option value="{{ $position->id }}" {{ old('position_id', $position->position->id ?? '') == $position->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="password" name="password" maxlength="255" class="form-control @error('password') is-invalid @enderror" required>
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" class="form-control @error('administrative_responsible') is-invalid @enderror" id="administrative_responsible"
                                                name="administrative_responsible" value="1" {{ old('administrative_responsible', null) ? 'checked' : '' }}>
