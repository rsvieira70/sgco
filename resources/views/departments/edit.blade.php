                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            ...
                            <input type="text" id="description" name="description" value="{{$department->description}}" maxlength="50" class="form-control {{$errors->has('description') ? 'is-invalid' :''}}" placeholder={{ __('Department') }} autofocus>
