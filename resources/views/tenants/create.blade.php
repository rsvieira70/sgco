...
@endsection
@section('content')
    <form action="{{ route('tenants.store') }}" method="POST" class="form-horizontal">
        @csrf
        <div class="row">
            <div class="col-sm-12">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                ...
                                <input type="text" id="social_reason" name="social_reason"
                                    value="{{ old('social_reason', null) }}" maxlength="60"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="fancy_name" name="fancy_name"
                                    value="{{ old('fancy_name', null) }}" maxlength="50"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="employer_identification_number"
                                        ...
                                        value="{{ old('employer_identification_number', null) }}"
                                        maxlength="11"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="state_registration" name="state_registration"
                                        value="{{ old('state_registration',null) }}"
                                        maxlength="11"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="municipal_registration" name="municipal_registration"
                                        value="{{ old('municipal_registration', null) }}"
                                        maxlength="11"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="zip_code" name="zip_code"
                                        value="{{ old('zip_code', null) }}" maxlength="8"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="address" name="address"
                                    value="{{ old('address', null) }}" maxlength="70"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="house_number" name="house_number"
                                    value="{{ old('house_number', null) }}" maxlength="10"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="complement" name="complement"
                                    value="{{ old('complement', null) }}" maxlength="30"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="neighborhood" name="neighborhood"
                                    value="{{ old('neighborhood', null) }}" maxlength="30"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city', null) }}"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="state" name="state"
                                    value="{{ old('state', null) }}" maxlength="2"
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="dceu" name="dceu" value="{{ old('dceu', null) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="telephone" name="telephone"
                                        value="{{ old('telephone', null) }}" maxlength="10"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="cell_phone" name="cell_phone"
                                        value="{{ old('cell_phone', null) }}" maxlength="11"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="whatsapp" name="whatsapp"
                                        value="{{ old('whatsapp', null) }}" maxlength="11"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="telegram" name="telegram"
                                        value="{{ old('telegram', null) }}" maxlength="11"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="facebook" name="facebook"
                                        value="{{ old('facebook', null) }}" maxlength="80"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="instagram" name="instagram"
                                        value="{{ old('instagram', null) }}" maxlength="80"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="twitter" name="twitter"
                                        value="{{ old('twitter', null) }}" maxlength="80"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="linkedin" name="linkedin"
                                        value="{{ old('linkedin', null) }}" maxlength="80"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="website" id="website" name="website"
                                    value="{{ old('website', null) }}" maxlength="255"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email"
                                    value="{{ old('email', null) }}" maxlength="255"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="note" class="form-control @error('note') is-invalid @enderror" rows="4"
                                    style="height: 30mm">{{ old('note', null) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
