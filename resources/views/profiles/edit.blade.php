                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $profile->name, null) }}"
                                    maxlength="50" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                    required autofocus>
                        ...
                        <div class="col-sm-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="house_number" name="house_number"
                                    value="{{ old('house_number', $profile->house_number, null) }}" maxlength="10"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="neighborhood" name="neighborhood"
                                    value="{{ old('neighborhood', $profile->neighborhood, null) }}" maxlength="30"
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city', $profile->city, null) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="cell_phone" name="cell_phone"
                                        value="{{ old('cell_phone', $profile->cell_phone, null) }}" maxlength="11"
